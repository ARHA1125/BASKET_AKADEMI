...
**Dashboard Coach (Mobile Command Center)**
*   **Session Mode:** Tampilan mobile-optimized (satu tangan) untuk input absensi & stats saat di lapangan.
*   **Player Scanner:** Akses cepat ke profil siswa untuk update nilai FUT Card.
*   **Tactical Board:** Akses instan ke Lesson Plan harian dan perpustakaan video drills.
