  ...
  return (
    <div className="p-4 sm:p-6 md:p-10 border-b border-slate-100">
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 sm:gap-0 mb-6 sm:mb-8">
        <div className="flex items-center gap-3 sm:gap-4">
           ...
           <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-0.5 sm:mt-1">Keunggulan dalam Olahraga</p>
           </div>
        </div>
        <div className="text-left sm:text-right w-full sm:w-auto">
           <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-slate-500 tracking-widest uppercase">TAGIHAN</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
        <div>
           <p className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-2 sm:mb-3">Ditagihkan Kepada</p>
           ...
           {data.student.studentNames && data.student.studentNames.length > 0 ? (
               <div className="mt-3 sm:mt-4">
                   <p className="text-xs font-semibold text-slate-500 mb-1.5 sm:mb-2">Siswa:</p>
        ...
        <div className="md:text-right">
           <div className="inline-block text-left md:text-right space-y-2 sm:space-y-3 w-full">
              <div className="flex justify-between md:justify-end gap-8 sm:gap-12">
                 <span className="text-xs sm:text-sm text-slate-500">Tanggal Diterbitkan:</span>
                 <span className="text-xs sm:text-sm font-semibold text-slate-900">{data.issueDate}</span>
              </div>
              <div className="flex justify-between md:justify-end gap-8 sm:gap-12">
                 <span className="text-xs sm:text-sm text-slate-500">Jatuh Tempo:</span>
