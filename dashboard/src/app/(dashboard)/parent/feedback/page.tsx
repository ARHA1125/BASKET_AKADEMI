...
export default function ParentFeedbackPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Title className="text-2xl font-bold text-slate-900 dark:text-white">Saran & Masukan Sistem</Title>
        <Text className="text-slate-500 dark:text-slate-400 mt-1">
          Bantu kami meningkatkan kualitas sistem. Laporkan bug, usulkan fitur baru, atau berikan masukan umum Anda di sini.
        </Text>
      </div>
